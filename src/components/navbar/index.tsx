...
const Navbar = (props: Props) => {
  return (
    <div className="absolute z-[50] top-0 left-0 right-0 flex items-center justify-center text-white font-semibold text-3xl text-center md:text-4xl lg:text-7xl">
      <div className="bg-clip-text w-full text-transparent drop-shadow-2xl bg-gradient-to-b from-white/100 to-white/50">
        <div className="w-full flex justify-between items-center gap-4 md:px-10 md:mt-2">
          ...
          <div className="flex justify-end text-xl items-center w-full gap-10">
            <Link href={'/'} className="hidden md:block">Home</Link>
            <Link href={'/'} className="hidden md:block">Services</Link>
